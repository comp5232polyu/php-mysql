    ...
    <?php foreach($items as $item) {  ?>
		<figure class="effect-oscar  wowload fadeInUp">
			...
			<figcaption>
				...
				<p><a href="desc?id=<?php echo $item->ID ?>">View more</a></p>
			</figcaption>
		</figure>
	<?php } ?>    
</div>
...
<div class="row text-center  wowload fadeInDownBig">
  ...
  <i class="fa fa-smile-o  fa-5x"></i><h4>24,000 Members</h4>
  </div>
  <div class="col-sm-3 col-xs-6">
  <i class="fa fa-rocket  fa-5x"></i><h4>100,000 Toys</h4>
  </div>
  <div class="col-sm-3 col-xs-6">
  <i class="fa fa-paypal  fa-5x"></i><h4>500,000 Transactions</h4>
  </div>
  <div class="col-sm-3 col-xs-6">
